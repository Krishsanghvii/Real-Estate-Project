...
<head>
    ...
    <link rel="stylesheet" href="css/real estate css.css">
    ...
    <form action="">
        ...
        <div class="inputBox">
            ...
            <select name="" id="">
                ...
                <option value="35 lkh rs">35 lkh </option>
                <option value=" 55 lkh rs">55 lkh </option>
                <option value="75 lkh rs">75 lkh </option>
                <option value="1 Cr rs">1 Cr </option>
                <option value="5 Cr+ rs">5 Cr </option>
            </select>
            <select name="" id="">
                <option value="" disabled hidden selected>maximum price</option>
                <option value="55 lkh  rs">55 lkh </option>
                <option value="$35000">75 lkh </option>
                <option value="$40000">1 cr </option>
                <option value="$45000">5 cr </option>
                <option value="$50000"> Above 5Cr </option>
            </select>
            <select name="" id="">
...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>buying home</h3>
            <p>Being a first time home buyer is guaranteed to be one of the most exciting times in your life and let us help you to make it the best and the perfect.</p>
        ...
        <div class="box">
            ...
            <h3>renting home</h3>
            <p>"If you put your love in a house it becomes a home."You seem to have covered the love part let us help you find  the house part.</p>
            <a href="#" class="btn">learn more</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>selling home</h3>
            <p>Selling a home can be very stressful these days,Let us help you make it easier and non-stressful for you with just a few steps.</p>
            <a href="#" class="btn">learn more</a>
        </div>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="location">
                    ...
                    <p>Marine Drive, Mumbai, India - 40020</p>
                </div>
                <div class="details">
                    <h3> <i class="fas fa-expand"></i> 3700 sqft </h3>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="location">
                    <h3>Neelkanth Valley </h3>
                    <p>Ghatkopar East, Mumbai, India - 400077</p>
                </div>
                <div class="details">
                    <h3> <i class="fas fa-expand"></i> 2100 sqft </h3>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="location">
                    <h3>JVPD Scheme</h3>
                    <p>Juhu West, Mumbai, India - 400049</p>
                </div>
                <div class="details">
                    <h3> <i class="fas fa-expand"></i> 4500 sqft </h3>
                    <h3> <i class="fas fa-bed"></i> 4 beds </h3>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="location">
                    <h3>Haridwar apartments</h3>
                    <p>Sion East, Mumbai, India - 400022</p>
                </div>
                <div class="details">
                    <h3> <i class="fas fa-expand"></i> 1000 sqft </h3>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="location">
                    <h3>Regency blds</h3>
                    <p>Pali Hill, Mumbai, India - 400051</p>
                </div>
                <div class="details">
                    <h3> <i class="fas fa-expand"></i> 5500 sqft </h3>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="location">
                    <h3> Legacy apartments</h3>
                    <p>Andheri East, Mumbai, India - 400104</p>
                </div>
                <div class="details">
...
<div class="icons-container">
    ...
    <div class="icons">
        ...
        <h3>email address</h3>
        <p>atiqlashari37@gmail.com</p>
        <p>natbedlevich@gmail.com</p>
    </div>

     <div class="icons">
        <img src="images/icon-3.png" alt="">
        <h3>office address</h3>
        <p>Kandivali, Mumbai, India - 400101</p>
    </div>
...
<section class="footer">
    ...
    <div class="footer-container">
        ...
        <div class="credit">created by <span> KAYN </span> | all rights reserved! 2022 </div>
